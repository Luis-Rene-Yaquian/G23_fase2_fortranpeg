 ...
 * @implements {Node}
 */
export class ConteoRangoOpciones {
    /**
     *
     * @param {Node[]} opciones
	 * @param {string=} inicio
	 * @param {string=} fin
     */
    constructor(opciones, inicio, fin) {
        this.opciones = opciones;
		this.inicio = inicio;
		this.fin = fin;
    }
...
export class Parentesis {
     ...
     */
    constructor(expr, identificador) {
        this.expr = expr;
